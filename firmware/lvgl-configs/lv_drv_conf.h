/**
 * LVGL Driver Configuration for SpoolBuddy
 * We use custom ESP-IDF RGB LCD driver, not LVGL drivers
 */
...
/* Disable all built-in display drivers - we use custom RGB LCD */
...
/* Disable all built-in input drivers - we may add touch later */
