...
#
# Examples:
#   ./docker-publish.sh 0.1.1b2           # Sequential build (default)
#   ./docker-publish.sh 0.1.1b2 --parallel # Build both archs simultaneously
#   ./docker-publish.sh 0.1.1-alpha       # Pre-release (no latest tag)
#
# Prerequisites:
...
# Configuration
REGISTRY="ghcr.io"
IMAGE_NAME="maziggy/spoolbuddy"
FULL_IMAGE="${REGISTRY}/${IMAGE_NAME}"
PLATFORMS="linux/amd64,linux/arm64"
BUILDER_NAME="spoolbuddy-builder"
...
if [ -z "$VERSION" ]; then
    ...
    echo "Example: $0 0.1.1b2"
    echo "         $0 0.1.1b2 --parallel  # Build both architectures simultaneously"
    exit 1
fi
